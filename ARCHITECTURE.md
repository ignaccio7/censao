...
| `/api/admin/vacunas`             | GET, POST, DELETE   | `route.ts::GET/POST/DELETE`   | `vacunas`                                                                                                      | API para administrar vacunas (ADMINISTRADOR y ENFERMERIA)                              |
| `/api/admin/vacunas/:uuid`       | GET, PATCH          | `route.ts::GET/PATCH`         | `vacunas`                                                                                                      | API para editar vacunas (ADMINISTRADOR y ENFERMERIA)                                   |
| `/api/admin/turnos`              | GET                 | `route.ts::GET`               | `turnos_catalogo`                                                                                              | API para listar turnos (ADMINISTRADOR)                                                 |
| `/api/admin/turnos/:codigo`      | GET, PATCH          | `route.ts::GET/PATCH`         | `turnos_catalogo`                                                                                              | API para editar un turno específico (ADMINISTRADOR)                                    |
| `/api/citas`                     | POST, PATCH, DELETE | `route.ts::POST/PATCH/DELETE` | `citas`, `tratamientos`, `consultas`                                                                           | API para administrar citas (DOCTOR_GENERAL y ENFERMERIA)                               |
| `/api/citas/:uuid`               | GET, PATCH, DELETE  | `route.ts::GET/PATCH/DELETE`  | `citas`, `tratamientos`, `consultas`                                                                           | API para administrar una cita específica (DOCTOR_GENERAL y ENFERMERIA)                 |
