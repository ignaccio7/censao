...
const IconClipboardText = ({ className = '', size = '24' }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
...
const IconSystem = ({ className = '', size = '24' }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
...
const IconCredential = ({ className = '', size = '24' }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
...
const IconTrash = ({ className = '', size = '24' }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
...
const IconVaccineBottle = ({ className = '', size = '24' }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
...
const IconFileCheck = ({ className = '', size = '24' }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
...
const IconRefresh = ({ className = '', size = '24' }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
...
const IconSpin = ({ className = '', size = '24' }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
...
const IconSun = ({ className = '', size = '24' }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
...
const IconSunset = ({ className = '', size = '24' }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
...
const IconDatabase = ({ className = '', size = '24' }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
...
const IconCornerRightUp = ({ className = '', size = '24' }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
