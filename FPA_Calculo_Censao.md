...
*Nota: Asumiremos que no hay **Archivos de Interfaz Externa (EIF)** ya que todos los datos (doctores, pacientes, turnos) se gestionan internamente en tu base de datos de PostgreSQL.*
...
*Nota: Un VAF de 1.03 significa que el proyecto es un 3% más complejo que el promedio debido a que es 100% online y requiere actualizaciones en vivo para los turnos.*
...
*Si una persona trabaja 8 hrs al día (160 hrs al mes), este proyecto equivale a aproximadamente **13 meses de trabajo continuo** para un solo desarrollador.*
